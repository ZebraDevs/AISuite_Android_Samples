 ...
 *
 * Usage:
 * - Instantiate the ProductRecognitionSampleAnalyzer with the appropriate callback, localizer, feature extractor, and recognizer.
 * - Implement the SampleDetectionCallback interface to handle recognition results.
 ...
 */
public class ProductRecognitionSampleAnalyzer implements ImageAnalysis.Analyzer{

    public interface SampleDetectionCallback {
    ...
    private final SampleDetectionCallback callback;
     ...
     */
    public ProductRecognitionSampleAnalyzer(SampleDetectionCallback callback, Localizer localizer, FeatureExtractor featureExtractor, Recognizer recognizer) {
