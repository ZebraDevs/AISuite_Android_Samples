...
/**
 * The TextOCRAnalyzer class implements the ImageAnalysis.Analyzer interface and is responsible
 ...
 * Usage:
 * - Instantiate the TextOCRAnalyzer with the appropriate DetectionCallback and TextOCR instance.
 ...
 * - TextOCR: Processes image data to detect and recognize text.
...
class TextOCRAnalyzer(
     ...
     * @return A list of ParagraphEntity objects representing the detected text.
     */
