...
/**
 * ProductRecognitionLegacySample is a Kotlin class that demonstrates the use of AI models to recognize products
 ...
 */
class ProductRecognitionLegacySample(private val context: Context) {

    // Tag used for logging purposes
    private val TAG = "ProductRecognitionLegacySample"
    ...
    /**
     * Initializes the ProductRecognitionLegacySample by setting up the localizer, feature extractor,
