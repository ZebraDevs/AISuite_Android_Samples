    ...
    ZebraBottomSheet(
        ...
        descriptionBulletItems = (
                listOf(
                    ...
                    stringResource(id = R.string.resolution_bottom_sheet_resolution_12mp) to listOf(
                        stringResource(id = R.string.resolution_bottom_sheet_12mp_high) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_12mp_best) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_12mp_slowest) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_12mp_limited) to listOf(stringResource(id = R.string.resolution_bottom_sheet_12mp_limited_bold))
                    ),
                    stringResource(id = R.string.resolution_bottom_sheet_resolution_16mp) to listOf(
                        stringResource(id = R.string.resolution_bottom_sheet_16mp_maximum) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_16mp_best) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_16mp_slowest) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_16mp_limited) to listOf(stringResource(id = R.string.resolution_bottom_sheet_16mp_limited_bold))
                    ),
                    stringResource(id = R.string.resolution_bottom_sheet_resolution_maximum) to listOf(
                        stringResource(id = R.string.resolution_bottom_sheet_maximum_detail) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_maximum_highest) to listOf(stringResource(id = R.string.resolution_bottom_sheet_maximum_highest_bold)),
                        stringResource(id = R.string.resolution_bottom_sheet_maximum_slowest) to listOf(""),
                        stringResource(id = R.string.resolution_bottom_sheet_maximum_limited) to listOf(stringResource(id = R.string.resolution_bottom_sheet_maximum_limited_bold))
                    )
                )
                ),
