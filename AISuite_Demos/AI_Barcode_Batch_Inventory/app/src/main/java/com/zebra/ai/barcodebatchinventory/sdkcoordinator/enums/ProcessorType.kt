...
/**
 * Enum representing the available processor types for running AI inference in the batch inventory app.
...
enum class ProcessorType(
    ...
    AUTO(
        R.string.processor_type_auto,
        R.string.processor_type_auto_id);
}