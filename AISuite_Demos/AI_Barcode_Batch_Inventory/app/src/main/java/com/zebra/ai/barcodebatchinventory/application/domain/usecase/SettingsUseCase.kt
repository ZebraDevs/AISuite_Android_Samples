...
class SettingsUseCase(
    ...
    */
    ...
    /**
     * Backward compatibility: applies currently saved settings to coordinator.
     * Prefer [applySettingsToCoordinator] or [applyDraftSettingsToCoordinator] in new code.
     */
