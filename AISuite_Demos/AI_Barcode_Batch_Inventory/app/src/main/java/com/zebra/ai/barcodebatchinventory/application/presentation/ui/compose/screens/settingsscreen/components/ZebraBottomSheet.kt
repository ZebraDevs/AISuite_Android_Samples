...
package com.zebra.ai.barcodebatchinventory.application.presentation.ui.compose.screens.settingsscreen.components
...
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.AppFonts
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.BottomSheetDividerColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.CardContainerColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.CardDividerColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.CardHeaderBackgroundColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.CardHeaderTextPrimaryColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.IconTintColor
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.theme.ScrimColor
                        ...
                        Card(
                            ...
                            Column(Modifier.fillMaxWidth()) {
                                Row(
                                    ...
                                    ZebraText(
                                        textValue = stringResource(id = R.string.zebra_bottom_sheet_recommendation_tips),
                                        fontSize = AppDimensions.dialogTextFontSizeMedium,
                                        fontWeight = FontWeight.SemiBold,
                                        textColor = CardHeaderTextPrimaryColor,
                                    )
    ...
    Column {
        ...
        bulletItems.forEach { (bullet, boldWords) ->
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.zebra_bottom_sheet_bullet_point),
                    fontSize = AppDimensions.dialogTextFontSizeMedium,
