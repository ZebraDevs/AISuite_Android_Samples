...
import com.zebra.ai.barcodebatchinventory.application.presentation.ui.compose.screens.settingsscreen.components.HyperlinkText
        ...
        descriptionText = {
            Column {
                ...
                HyperlinkText(
                    ...
                    stringResource(id = R.string.inference_bottom_sheet_zebra_platform_url)
                )
            }
        },
