...
/**
 * Enum representing available camera resolutions for the batch inventory app.
...
enum class Resolution(
    ...
    /** 12 Megapixel resolution: 4608x2592 */
    TWELVE_MP(
        R.string.resolution_12mp,
        4080, 3060
    ),

    /** 16 Megapixel resolution: 5344x3008 */
    SIXTEEN_MP(
        R.string.resolution_16mp,
        4656, 3496
    ),

    MAXIMUM(
    R.string.resolution_maximum,
    8192, 6144  // Special marker: 0x0 = use camera's max resolution
    );
}