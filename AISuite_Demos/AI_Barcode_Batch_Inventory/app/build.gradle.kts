...
android {
    namespace = "com.zebra.ai.barcodebatchinventory"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.zebra.ai.barcodebatchinventory"
        minSdk = 33
        targetSdk = 36
        ...
        buildConfigField("String", "APP_NAME", "\"AI Barcode Batch Inventory\"")
        buildConfigField(
            "String",
...
dependencies {
    ...
    // Below dependency is to get AI Data Capture SDK (local AAR build)
    implementation(libs.zebra.ai.vision.sdk) { artifact { type = "aar" } }

    //Below dependency is to get Barcode Decoder model for AI Data Capture SDK
