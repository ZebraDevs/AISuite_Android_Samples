...
package com.zebra.ai.barcodefinder.ui.compose.screens.navbarscreen
...
import com.zebra.ai.barcodefinder.ui.compose.screens.navbarscreen.components.NavigationMenuItem
import com.zebra.ai.barcodefinder.ui.compose.screens.navbarscreen.model.NavigationItem
import com.zebra.ai.barcodefinder.ui.theme.AppDimensions
import com.zebra.ai.barcodefinder.ui.theme.navBarBackgroundColor
import com.zebra.ai.barcodefinder.ui.theme.navBarDividerColor
import com.zebra.ai.barcodefinder.ui.theme.navBarZebraTextColor
    ...
    Column(
        ...
        Column {
            ...
            Column(
                ...
                val navigationItems = listOf(
                    ...
                    NavigationItem(
                        stringResource(id = R.string.navbar_configure_demo),
                        Icons.Default.Edit,
                    ...
                    NavigationItem(
                        stringResource(id = R.string.navbar_about),
                        Icons.Default.Info,
                        onNavigateToAbout
                    ),
                    NavigationItem(
                        stringResource(id = R.string.navbar_feedback),
                ...
                navigationItems.forEachIndexed { index, item ->
                    val isConfigureDemo =
                        item.title == stringResource(id = R.string.navbar_configure_demo)
        ...
        Column {
            ...
            Column(
                ...
                ZebraText(
                    textValue = stringResource(id = R.string.navbar_watermark),
