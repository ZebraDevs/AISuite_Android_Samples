...
package com.zebra.ai.barcodefinder.ui.compose.screens.scanresultscreen.components
...
import com.zebra.ai.barcodefinder.ui.theme.AppTextStyles.HamburgerDescriptionText
import com.zebra.ai.barcodefinder.ui.theme.AppTextStyles.ScanResultTextSmall
...
fun SimpleScanResultItem(result: ScanResult, barcode: ActionableBarcode?) {
    Column(
        ...
        // Barcode
        ZebraText(
            textValue = "${stringResource(R.string.scan_barcode)} ${result.barcode}",
        ...
        Row(
            ...
            ZebraText(
                textValue = result.status.text
                    .replace("Replenish: Yes", "Replenish: True")
                    .replace("Replenish: No", "Replenish: False"),
