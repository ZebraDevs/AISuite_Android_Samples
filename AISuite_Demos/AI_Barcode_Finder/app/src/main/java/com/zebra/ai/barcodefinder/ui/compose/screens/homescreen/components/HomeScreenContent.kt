...
package com.zebra.ai.barcodefinder.ui.compose.screens.homescreen.components

import HomeScreenUiDefaults
...
import com.zebra.ai.barcodefinder.ui.compose.screens.navbarscreen.NavBarScreen
...
import com.zebra.ai.barcodefinder.ui.theme.disabledMain
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                Column(
                    ...
                    ZebraText(
                        textValue = stringResource(id = R.string.home_settings_header),
...
//                    Spacer(modifier = Modifier.height(AppDimensions.dimension_2dp))
                    Row(
                        ...
                        ZebraText(
                            textValue = stringResource(id = R.string.home_bullet_point),
                            fontSize = AppDimensions.dialogTextFontSizeMedium,
                            textColor = AppColors.TextBlack,
                            fontWeight = FontWeight.Bold
                        )
                        Column {
                            Text( // Keep Material Text for buildAnnotatedString
                                text = buildAnnotatedString {
                                    append(stringResource(id = R.string.home_model_input))
...
//                    Spacer(modifier = Modifier.height(AppDimensions.dimension_2dp))
                    Row(
                        ...
                        Column {
                            Text( // Keep Material Text for buildAnnotatedString
                                text = buildAnnotatedString {
                                    append(stringResource(id = R.string.home_resolution))
                                    withStyle(style = SpanStyle(fontWeight = FontWeight.Light)) {
...
//                    Spacer(modifier = Modifier.height(AppDimensions.dimension_2dp))
                    Row(
                        ...
                        Column {
                            Text( // Keep Material Text for buildAnnotatedString
                                text = buildAnnotatedString {
                                    append(stringResource(id = R.string.home_processor_type))
                                    withStyle(style = SpanStyle(fontWeight = FontWeight.Light)) {
                ...
                ZebraButton(
                    ...
                    text = stringResource(id = R.string.home_restore_settings),
                    onClick = {
                ...
                ZebraButton(
                    ...
                    text = if (uiState.isScanning) "" else stringResource(id = R.string.home_start_scan_button),
