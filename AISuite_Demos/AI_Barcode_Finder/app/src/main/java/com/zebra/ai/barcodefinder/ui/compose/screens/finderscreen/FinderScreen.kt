...
package com.zebra.ai.barcodefinder.ui.compose.screens.finderscreen
...
import com.zebra.ai.barcodefinder.ui.compose.screens.finderscreen.components.FinderActionHandler
 ...
 *
 * @param entityTrackerViewModel The ViewModel for entity tracking logic
...
fun FinderScreen(
    ...
    val overlayItems by entityTrackerViewModel.overlayItems.collectAsState(initial = emptyList())
        ...
        val observer = LifecycleEventObserver { _, event ->
            when (event) {
                Lifecycle.Event.ON_RESUME -> {
                    // Handle onResume
                    entityTrackerViewModel.clearOverlayItems()
                }
            ...
            if (uiState.isInitialized) {
                ...
                AndroidView(
                    factory = { ctx ->
                        PreviewView(ctx).also { previewView ->
                            ...
                            entityTrackerViewModel.bindCameraToLifecycle(
                                lifecycleOwner,
                                previewView
                            )
                        }
                    ...
                    onItemClick = { item ->
                        item.actionableBarcode?.let { actionableBarcode ->
                            ...
                            if (actionableBarcode.actionState != ActionState.STATE_ACTION_COMPLETED) {
                                entityTrackerViewModel.selectBarcode(actionableBarcode)
                            }
                        }
                    },
                    modifier = Modifier.fillMaxSize()
                ...
                if (!uiState.isInitialized) {
                    Card(
                        ...
                        ZebraText(
                            textValue = stringResource(R.string.init_barcode_scanner),
                            textColor = white,
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = stringResource(R.string.config_camera_permission),
