...
package com.zebra.ai.barcodefinder.ui.compose.screens.configurescreen.components
...
import com.zebra.ai.barcodefinder.ui.compose.screens.configurescreen.dialog.actionablebarcodedialog.ActionableBarcodeDialog
import com.zebra.ai.barcodefinder.ui.compose.screens.configurescreen.dialog.configureactiondialog.ConfigureActionDialog
...
fun ConfigureActionHandler(
    ...
    configurations: List<ActionableBarcode> = emptyList(),
    ...
    if (showActionableBarcodeDialog) {
        androidx.compose.foundation.layout.Box(
            modifier = androidx.compose.ui.Modifier
                .fillMaxSize()
                .background(com.zebra.ai.barcodefinder.ui.theme.AppDimensions.WeightHalf.let { alpha ->
