...
package com.zebra.ai.barcodefinder.ui.compose.screens.settingsscreen
...
import com.zebra.ai.barcodefinder.ui.compose.screens.settingsscreen.components.RadioButtonOption
import com.zebra.ai.barcodefinder.ui.compose.screens.settingsscreen.components.SettingsCard
import com.zebra.ai.barcodefinder.ui.compose.screens.settingsscreen.components.SwitchOption
...
import com.zebra.ai.barcodefinder.ui.theme.darkBackground
import com.zebra.ai.barcodefinder.ui.theme.mainInverse
import com.zebra.ai.barcodefinder.ui.theme.settingsLazyColumnBackground
import com.zebra.ai.barcodefinder.ui.theme.textBlack
...
fun SettingsScreen(
    ...
    Column(
        ...
        TopAppBar(
            title = {
                ZebraText(
                    textValue = stringResource(id = R.string.setting_barcode_recognizer_title),
            ...
            navigationIcon = {
                IconButton(onClick = onBackClick) {
                    Icon(
                        ...
                        contentDescription = stringResource(id = R.string.setting_back_icon_description),
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Column(
                                ...
                                Text(
                                    buildAnnotatedString {
                                        withStyle(
                                            ...
                                            append(stringResource(id = R.string.setting_model_input_size_description_part1))
                                        }
                                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                            append(stringResource(id = R.string.setting_model_input_size_description_part2))
                                        }
                                        withStyle(
                                            style = SpanStyle(
                                                fontWeight = FontWeight(
                                            ...
                                            append(stringResource(id = R.string.setting_model_input_size_description_part3))
                                        }
                                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                        ...
                                        withStyle(
                                            ...
                                            append(stringResource(id = R.string.setting_model_input_size_description_part4))
                                        }
                                    },
                                ...
                                ZebraText(
                                    textValue = stringResource(id = R.string.setting_more_button),
                        ...
                        Column(
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_model_input_640_title),
                                subtitle = stringResource(id = R.string.setting_model_input_640_subtitle),
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_model_input_1280_title),
                                subtitle = stringResource(id = R.string.setting_model_input_1280_subtitle),
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_model_input_1600_title),
                                subtitle = stringResource(id = R.string.setting_model_input_1600_subtitle),
...
//                            RadioButtonOption(
//                                title = stringResource(id = R.string.setting_model_input_2560_title),
//                                subtitle = stringResource(id = R.string.setting_model_input_2560_subtitle),
//                                selected = settings.modelInput == ModelInput.EXTRA_LARGE_2560,
//                                onSelected = {
//                                    settingsViewModel.updateModelInput(ModelInput.EXTRA_LARGE_2560)
//                                }
//                            )
                        }
                ...
                SettingsCard(
                    ...
                    Column(
                                ...
                                Text(
                                    buildAnnotatedString {
                                        withStyle(style = SpanStyle(fontWeight = FontWeight.Normal)) {
                                            append(stringResource(id = R.string.setting_resolution_description_part1))
                                        }
                                        withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) {
                                            append(stringResource(id = R.string.setting_resolution_description_part2))
                                        }
                                        withStyle(style = SpanStyle(fontWeight = FontWeight.Normal)) {
                                            append(stringResource(id = R.string.setting_resolution_description_part3))
                                        }
                                    },
                                    color = textBlack, // Changed from Color.Black
                                    fontSize = AppDimensions.dialogTextFontSizeSmall,
                        ...
                        Column(
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_resolution_1mp_title), // Replacing "1MP (1280 × 720)"
                                subtitle = stringResource(id = R.string.setting_resolution_1mp_subtitle), // Replacing
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_resolution_2mp_title), // Replacing "2MP (1920 × 1080)"
                                subtitle = stringResource(id = R.string.setting_resolution_2mp_subtitle), // Replacing
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_resolution_4mp_title), // Replacing "4MP (2688 × 1512)"
                                subtitle = stringResource(id = R.string.setting_resolution_4mp_subtitle), // Replacing
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_resolution_8mp_title), // Replacing "8MP (3840 × 2160)"
                                subtitle = stringResource(id = R.string.setting_resolution_8mp_subtitle), // Replacing
                ...
                SettingsCard(
                    ...
                    Column(
                                ...
                                Text(
                                    buildAnnotatedString {
                                        withStyle(
                                            ...
                                            append(stringResource(id = R.string.setting_inference_description1))
                                        }
                                        withStyle(
                                            style = SpanStyle(
                                                fontWeight = FontWeight(
                                            ...
                                            append(stringResource(id = R.string.setting_inference_description2))
                                        }
                                    },
                                    fontSize = AppDimensions.dialogTextFontSizeSmall,
                                    color = textBlack, // Changed from Color.Black
                        ...
                        Column(
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_inference_dsp_title), // Replacing "DSP (Digital Signal Processor)"
                                subtitle = stringResource(id = R.string.setting_inference_dsp_subtitle), // Replacing "Best Choice"
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_inference_gpu_title), // Replacing "GPU (Graphics Processing Unit)"
                                subtitle = stringResource(id = R.string.setting_inference_gpu_subtitle),
                            ...
                            RadioButtonOption(
                                title = stringResource(id = R.string.setting_inference_cpu_title), // Replacing "CPU (Central Processing Unit)"
                                subtitle = stringResource(id = R.string.setting_inference_cpu_subtitle),
            ...
            item {
                ...
                Box(
                    ...
                    ZebraButton(
                        ...
                        text = stringResource(id = R.string.setting_reset_to_default),
                        textColor = borderPrimaryMain,
